            ...
            <div class="table-wrap">
                <table>
                    ...
                    <tbody id="pacientesBody">
                        ...
                        <tr onclick="verPaciente('{{ $paciente->dui }}')" style="cursor:pointer;" data-nombre="{{ strtolower($paciente->nombre.' '.$paciente->apellido) }}" data-dui="{{ $paciente->dui }}" data-telefono="{{ $paciente->telefono }}">
                            <td>
...
<div class="modal-overlay" id="modalPaciente">
    <div class="modal">
        <div class="modal-header">
            <h2>{!! icon('users',18) !!} <span id="modalTitle">Datos del Paciente</span></h2>
